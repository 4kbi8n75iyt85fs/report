...
import { ChevronDown, Target, Users, TrendingUp, CheckCircle } from "lucide-react";

export function HeroSection() {
    const scrollToContent = () => {
        const element = document.getElementById("the-business");
        if (element) {
            ...
            <div className="container mx-auto px-6 md:px-8 lg:px-12 max-w-7xl relative z-10 py-20 md:py-0">
                <div className="grid lg:grid-cols-5 gap-12 lg:gap-16 items-center">
                    ...
                    <div className="lg:col-span-3">
                        ...
                        <p className="text-xl md:text-2xl font-medium opacity-90 mb-4 leading-relaxed max-w-2xl">
                            A validated tutoring business ready for scale.
                        </p>
                        <p className="text-lg md:text-xl opacity-80 mb-8 leading-relaxed max-w-2xl">
                            After 17 attempts and years of grinding, the marketing and sales model is finally cracked.
                            Now I need your execution speed to build out operations and scale it.
                        </p>
                    </div>
                            ...
                            <div className="space-y-6">
                                <div className="flex items-start gap-4">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-sm opacity-80 mt-1">Sales Closed Recently</p>
                                    </div>
                                </div>
                                <div className="flex items-start gap-4">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-sm opacity-80 mt-1">Leads Generated</p>
                                    </div>
                                </div>
                                <div className="flex items-start gap-4">
                                    <Target className="w-8 h-8 mt-1 flex-shrink-0" />
                                    <div>
                                        <p className="text-4xl md:text-5xl font-bold">3</p>
                                        <p className="text-sm opacity-80 mt-1">Pricing Plans Validated</p>
                                    </div>
                                </div>
                                <div className="flex items-start gap-4">
                                    <TrendingUp className="w-8 h-8 mt-1 flex-shrink-0" />
                                    <div>
                                        <p className="text-4xl md:text-5xl font-bold">~3mo</p>
                                        <p className="text-sm opacity-80 mt-1">To Profitability</p>
                                    </div>
                                </div>
                            </div>
                        </div>
